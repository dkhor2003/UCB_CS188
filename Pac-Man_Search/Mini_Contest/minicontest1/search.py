...
def depthFirstSearch(problem):
    ...
    while not stack.isEmpty():
        ...
        furtherMoves = problem.getSuccessors(state)
        
        for move in furtherMoves:
            nextState = move[0]
            if nextState in explored:
                continue
            action = move[1]
            new_move = moves + [action]
            stack.push((nextState, new_move))
    ...
    while not heap.isEmpty():
        ...
        if state not in explored:
            ...
            for move in nextMoves:
                ...
                new_move = moves + [action]
                new_cost = problem.getCostOfActions(moves) + cost
...
# A* score is the cost of the path plus the cost of the heuristic measure, which is an estimate of how far it still needs 
# to go to get to the goal state. 
